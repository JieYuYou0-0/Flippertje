...
namespace GhibliFlix
{
    public class MovieCollection
    {
        ...
        public class Movie2 : Movie
        {
            public Movie2()
            {
                this.Title = "Howl's Moving Castle";
                this.Price = 12.00;
                this.Description =
        ...
        public class Movie3 : Movie
        {
            public Movie3()
            {
                this.Title = "Princess Mononoke";
                this.Price = 15.00;
                this.Description = "The story follows a young Emishi prince named Ashitaka, and his involvement in a struggle between the gods of a forest and the humans who consume its resources.";
                this.Duration = "120";
        ...
        public class Movie4 : Movie
        {
            public Movie4()
            {
                this.Title = "Kiki's Delivery Service";
                this.Price = 16.00;
                this.Description = "It is a tradition for all young witches to leave their families on the night of a full moon and fly off into the wide world to learn their craft.\n" +
        ...
        public class Movie5 : Movie
        {
            public Movie5()
            {
                this.Title = "Ponyo";
                this.Price = 20.00;
                this.Description = "When Sosuke, a young boy who lives on a clifftop overlooking the sea, rescues a stranded goldfish named Ponyo, he discovers more than he bargained for.\n" +
        ...
        public class Movie6 : Movie
        {
            public Movie6()
            {
                this.Title = "Spirited Away";
                this.Price = 20.00;
                this.Description = "Chihiro's family is moving to a new house, but when they stop on the way to explore an abandoned village, her parents undergo a mysterious transformation and Chihiro is whisked into a world of fantastic spirits ruled over by the soceress Yubaba.\n" +
        ...
        public class Movie7 : Movie
        {
            public Movie7()
            {
                this.Title = "The Cat Returns";
                this.Price = 16.00;
                this.Description = "Haru is walking home after a dreary day of school when she spies a cat with a small gift box in its mouth crossing a busy street, and she jumps in front of traffic to save the cat from an oncoming truck.\n" +
        ...
        public class Movie8 : Movie
        {
            public Movie8()
            {
                this.Title = "The Wind Rises";
                this.Price = 18.00;
                this.Description = "Jiro dreams of flying and designing beautiful airplanes, inspired by the famous Italian aeronautical designer Caproni.\n" +
